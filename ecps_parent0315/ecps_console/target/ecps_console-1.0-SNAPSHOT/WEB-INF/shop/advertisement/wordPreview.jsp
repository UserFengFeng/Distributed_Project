...
<body id="main">
<p style="<c:if test='${not empty width}'>width:${width}px;</c:if>
   <c:if test='${not empty height}'>height:${height}px;</c:if>overflow:hidden;background-color:#fff">${ad.adWords}</p>  
</body>
