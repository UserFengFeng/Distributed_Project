...
<div class="frameR"><div class="content">
	...
	<div class="loc icon"><samp class="t12"></samp><fmt:message key='menu.current.loc'/>：促销活动&nbsp;&raquo;&nbsp;<span class="gray">添加团购项目</span>
    </div>
	<form id="form111" name="form111" action="${base}/groupon/addGroupon.do" method="post" enctype="multipart/form-data">
		<div class="edit set">
			...
			<p><label><samp>*</samp>团购标题：</label><input type="text" id="grouponTitle" name="grouponTitle" maxlength="180" class="text state" reg1="^(.{1,180})$" desc="180以内任意字符"/>
			</p>
            <p><label class="alg_t">团购图片：</label><img id="grouponImgImgSrc" src="<c:url value='/ecps/console/images/logo266x64.png'/>" height="100" width="100" /></p>
            ...
            <input type='hidden' id='grouponImg' name='grouponImg' />
            <input type="hidden" id="isGrouponImgSuccess" value=""/>
            </p>
			<p><label>赠品信息：</label><input type="text" id="giftInfo" name="giftInfo" class="text state" maxlength="180"  reg1="^(.{1,180})$" desc="180以内任意字符"/>
				<span class="pos">&nbsp;</span>
			</p>
			...
			<p><label>排序：</label><input type="text" name="grouponOrder" id="grouponOrder" class="text state" maxlength="3"  reg="^[0-9]{0,3}$" tip="必须是1-3位数字"/>
				<span class="pos" id="grouponOrderErr">&nbsp;</span>
			</p>
			<p><label>虚拟购买：</label><input type="text" name="virtualSales" id="virtualSales" class="text state" maxlength="5"  reg="^[0-9]{0,5}$" tip="必须是1-5位数字"/>
