...
<form id="form1" name="form1" action="${base}/item/brand/listBrand.do" method="post">
    <div class="page_c">
        ...
        <span class="r inb_a">
            <a href="${path }/WEB-INF/shop/item/addbrand.jsp" title="添加" class="btn80x20">添加</a>
        </span>
    </div>
	...
	<table cellspacing="0" summary="" class="tab">
		...
		<tr>
			...
			<tr>
				...
				<td>2</td>
				<td>
					<a href="${path }/WEB-INF/shop/item/editbrand.jsp?brandId=3121">编辑</a>
			...
			<tr>
				...
				<td></td>
				<td>
					<a href="${path }/WEB-INF/shop/item/editbrand.jsp?brandId=1000">编辑</a>
			...
			<tr>
				...
				<td></td>
				<td>
					<a href="${path }/WEB-INF/shop/item/editbrand.jsp?brandId=1001">编辑</a>
			...
			<tr>
				...
				<td></td>
				<td>
					<a href="${path }/WEB-INF/shop/item/editbrand.jsp?brandId=1002">编辑</a>
			...
			<tr>
				...
				<td></td>
				<td>
					<a href="${path }/WEB-INF/shop/item/editbrand.jsp?brandId=1003">编辑</a>
			...
			<tr>
				...
				<td></td>
				<td>
					<a href="${path }/WEB-INF/shop/item/editbrand.jsp?brandId=1004">编辑</a>
			...
			<tr>
				...
				<td></td>
				<td>
					<a href="${path }/WEB-INF/shop/item/editbrand.jsp?brandId=1005">编辑</a>
			...
			<tr>
				...
				<td></td>
				<td>
					<a href="${path }/WEB-INF/shop/item/editbrand.jsp?brandId=1006">编辑</a>
			...
			<tr>
				...
				<td></td>
				<td>
					<a href="${path }/WEB-INF/shop/item/editbrand.jsp?brandId=1007">编辑</a>
			...
			<tr>
				...
				<td></td>
				<td>
					<a href="${path }/WEB-INF/shop/item/editbrand.jsp?brandId=1008">编辑</a>
			...
			<tr>
				...
				<td></td>
				<td>
					<a href="${path }/WEB-INF/shop/item/editbrand.jsp?brandId=1009">编辑</a>
			...
			<tr>
				...
				<td></td>
				<td>
					<a href="${path }/WEB-INF/shop/item/editbrand.jsp?brandId=1010">编辑</a>
			...
			<tr>
				...
				<td>1</td>
				<td>
					<a href="${path }/WEB-INF/shop/item/editbrand.jsp?brandId=1041">编辑</a>
			...
			<tr>
				...
				<td>1</td>
				<td>
					<a href="${path }/WEB-INF/shop/item/editbrand.jsp?brandId=1042">编辑</a>
			...
			<tr>
				...
				<td></td>
				<td>
					<a href="${path }/WEB-INF/shop/item/editbrand.jsp?brandId=1043">编辑</a>
