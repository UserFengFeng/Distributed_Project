...
<div class="w loc">
	...
	<p class="r"><a href="index.jsp" title="首页">首页</a><samp>&gt;</samp><a href="index.jsp" title="用户中心">用户中心</a><samp>&gt;</samp><span class="gray">订单详情</span></p>
...
<div class="w mt ofc">
	<div class="l wl">
		...
		<div class="box bg_gray">
			...
			<li><a href="myOrders.jsp" title="我的订单" class="here">我的订单</a></li>
		...
		<div class="box bg_gray">
			...
			<li><a href="deliverAddress.jsp" title="收货地址">收货地址</a></li>
		...
		<div class="confirm">
			...
			<div class="ofc">
				...
				<div class="tool">
					...
					<span class="r"><a href="javascirpt:void(0);" title="打印订单" class="inb btn66x23 mr">打印订单</a><a href="myOrders.jsp" class="inb btn96x23" title="返回订单列表">返回订单列表</a></span>
				</div>
