...
<body <decorator:getProperty property="body.id" writeEntireProperty="true"/> <decorator:getProperty
...
<div id="addItemID" class="alt alt2" style="display:none">
    ...
    <div class="c set">
        ...
        <p style="margin-top:5px"><input type="hidden" id="pageNo" name="pageNo"/><input type="hidden" id="keyword"
                                                                                         name="keyword"/>
            ...
            <label>价格范围：</label><input type="text" id="minPrice" name="minPrice" class="text20" size="5"/>--&nbsp;&nbsp;<input
                    type="text" id="maxPrice" name="maxPrice" class="text20" size="5"/>
            <input type="text" id="searchText" onFocus="onfocustxt();" onBlur="onblurtxt();" name="searchText"
                   value="${userSearch}" title="请输入商品编号或商品名称" class="text20 medium gray"/><input type="button"
                                                                                                 id="query" name="query"
                                                                                                 class="hand btn83x23"
                                                                                                 value="查询"/>
        </p>
...
<div id="editSimCardLabels" class="alt alt2" style="display:none">
    ...
    <div class="c set">
        ...
        <p style="margin-top:5px"><input type="hidden" id="lblPageNo" name="lblPageNo"/><input type="hidden"
                                                                                               id="lblkeyword"
                                                                                               name="lblkeyword"/>
            <label>标签名称：</label><input type="text" id="lblSearchText" name="lblSearchText" value="${userSearch}"
                                       title="请输入标签名称" class="text20 medium gray"/><input type="button" id="lblQuery"
                                                                                          name="lblQuery"
                                                                                          class="hand btn83x23"
                                                                                          value="查询"/>
        </p>
...
<div id="addItemNote" class="alt" style="display:none">
    ...
    <div class="c set">
        ...
        <p id="pIMSI" style="display:none"><label><font color="red"><b>*</b></font><span id="sIMSI">IMSI：</span></label><input
                id="inputIMSI" name="inputIMSI" type="text"></input></p>
        <p id="pICCID" style="display:none"><label><font color="red"><b>*</b></font>ICCID：</label><input id="inputICCID"
                                                                                                         name="inputICCID"
                                                                                                         type="text"></input><a
                href="###" id="getIccidLink">白卡获取ICCID</a></p>
        <p><label>操作备注：</label><textarea id="itemNote" name="suitNote" rows="4" cols="21" value=""
                                         class="gray are"></textarea></p>
        <p><label>&nbsp;</label>
...
<div id="addItemNote5" class="alt" style="display:none">
    ...
    <div class="c set">
        ...
        <p><label>操作备注：</label><textarea id="itemNote5" name="suitNote" rows="4" cols="21" value=""
                                         class="gray are"></textarea></p>
        <p><label>&nbsp;</label>
...
<div id="jobNums" class="alt" style="display:none">
    ...
    <div class="c set">
        ...
        <p><label>备注：</label><textarea id="jobNote" name="jobNote" rows="4" cols="21" value=""
                                       class="gray are"></textarea></p>
        <p><label>&nbsp;</label>
...
<div id="confirm" class="alt" style="display:none">
    ...
    <div class="c set">
        ...
        <p class="alg_c"><input type="button" id="confirmOk" onclick="d('dd');" value="确 定"
                                class="hand btn83x23"/><input type="button" value="取 消" id="confirmReset"
                                                              class="hand btn83x23b"/></p>
    </div>
    <div class="f"></div>
</div>
...
<div id="confirmDiv" class="alt" style="display:none">
    ...
    <div class="c set">
        ...
        <p class="alg_c"><input type="button" id="confirmDivOk" onclick="" value="确 定" class="hand btn83x23"/><input
                type="button" value="取 消" id="confirmReset" onclick="tipHide('#confirmDiv')" class="hand btn83x23b"/>
        </p>
    </div>
    <div class="f"></div>
</div>
...
<div id="queryDiv1" class="alt" style="display:none">
    ...
    <div class="c set">
        ...
        <p id="showButton" class="alg_c">
            <input name="r" type="button" class="hand btn83x23 sub2" id="but5" onclick="confirm1(this.value);"
                   value="备货完成"/>
        </p>
    </div>
    <div class="f"></div>
...
<div id="targetTip" class="alt2 alt" style="display:none">
    ...
    <div class="c set">
        ...
        <p class="alg_c"><input type="button" value="确 认" id="targetTipC" class="hand btn83x23"/>&nbsp;&nbsp;<input
                type="button" value="取 消" id="targetTipReset" onclick="tipHide('#targetTip')" class="hand btn83x23b"/>
        </p>
    </div>
    <div class="f"></div>
</div>
<div id="linkMsg" class="alt" style="display:none">
    ...
    <div class="c set">
        ...
        <p id="showButton" class="alg_r"><input type="submit" value="确 认" onclick="tipHide('#linkMsg');"
                                                class="hand btn83x23"/></p>
    </div>
    <div class="f"></div>
</div>
...
<div id="tip" class="alt" style="display:none">
    ...
    <div class="c set">
        ...
        <p class="alg_c msg"></p>
        <p class="alg_r"><input type="button" id="Ok2" value="确 定" onclick="tipHide('#tip');" class="hand btn83x23"/>
        </p>
    </div>
    <div class="f"></div>
</div>
...
<div id="singleFail" class="alt" style="display:none">
    ...
    <div class="c set">
        ...
        <p class="alg_r">
            <input type="button" id="DeleteRolesButton" value="确 定" onclick="sdel()" class="hand btn83x23"/><input
                type="button" value="取 消" onclick="tipHide('#singleFail');" class="hand btn83x23b"/></p>
    </div>
    <div class="f"></div>
</div>
<!-- 删除多个广告位-->
<div id="batFail" class="alt" style="display:none">
    ...
    <div class="c set">
        ...
        <p class="alg_r">
            <input type="button" id="DeleteRolesButton" value="确 定" onclick="del()" class="hand btn83x23"/><input
                type="button" value="取 消" onclick="tipHide('#batFail');" class="hand btn83x23b"/></p>
    </div>
    <div class="f"></div>
</div>
...
<div id="payRecordMemoDiv" class="alt" style="display:none">
    ...
    <div class="c set">
        ...
        <ul class="uls">
            ...
            <li><label class="alg_t"><span class="red">*</span>备注：</label><textarea id="payRecordMemo" rows="7"
                                                                                    cols="30"></textarea></li>
...
<div id="confirmSaleSku" class="alt" style="display:none">
    ...
    <div class="c set">
        ...
        <div id="confirmClose" class="o" title="关闭"></div>
        <p class="alg_c">操作确认?</p>
        <p class="alg_c"><input type="button" id="confirmSaleSku" onclick="" value="确 定" class="hand btn83x23"/><input
                type="button" value="取 消" id="confirmReset" class="hand btn83x23b"/></p>
    </div>
    <div class="f"></div>
</div>
...
<div id="returnNoteDiv" class="alt" style="display:none">
    ...
    <div class="c set">
        ...
        <form id="attachFileForm" method="post">
            <p id="attachFileAttention"><label></label><span id="attachFileAttentionSpan"
                                                             style="color:red">请上传小于5mb的文件</span></p>
            <p id="attachFileDisplay" style="display: none"><label>&nbsp;</label><span
                    id="attachFileDisplayName"></span>&nbsp;<a href="###" id="attachFileDelete">删除</a></p>
            <p id="attachFileField"><label>质检报告：</label><input type="file" class="file" id="attachFile"
                                                               name="attachFile"/></p>
        </form>
        <p id="pJobNum" style="display: none"><label><font style="color:red;"><b>*</b></font>工单号：</label><input
                type="text" id="iJobNum" name="iJobNum" value=""></input></p>
        <p><label>操作备注：</label><textarea id="returnNote" name="returnNote" rows="4" cols="21" value=""
                                         class="gray are"></textarea></p>
        <p><label>&nbsp;</label>
...
<div id="importSimcardTip" class="alt" style="display:none">
    ...
    <div class="c set">
        ...
        <p class="alg_r"><input type="button" id="importSimcardTipOk" value="确 定"
                                onclick="tipHide('#importSimcardTip');" class="hand btn83x23"/></p>
    </div>
    <div class="f"></div>
</div>
<div id="recommItemConfig" class="alt" style="display:none">
    ...
    <div class="c set">
        ...
        <p><label>机型亮点：</label>
            <textarea id="itemHighlight" name="itemHighlight" rows="3" cols="31" value="" class="gray are"></textarea>
        </p>
        <p>
            <label>合约亮点：</label>
