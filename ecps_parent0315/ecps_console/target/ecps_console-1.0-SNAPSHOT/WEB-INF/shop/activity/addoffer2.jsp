	...
	$(document).ready(function(){
		...
		function showResponse(responseText, statusText){ 
			...
			if(obj.result=="success"){
				document.location.href="<c:url value='/ecps/console/activity/listoffer.do'/>?offerGroupId=${offerGroup.offerGroupId }&offerType=2";
			}
		}
	});
...
<div class="frameR"><div class="content">
    ...
    <div class="loc icon"><samp class="t12"></samp>当前位置:商品管理&nbsp;&raquo;&nbsp;<a href="${path}/activity/listOfferGroup.do">营销案管理</a>&nbsp;&raquo;&nbsp;<a href="${path}/activity/listoffer.do?offerGroupId=${offerGroup.offerGroupId }&offerType=2" title="${offerGroup.offerGroupName }的营销案档次">营销案档次</a>&nbsp;&raquo;&nbsp;<span class="gray">添加档次</span><a href="${path}/activity/listoffer.do?offerGroupId=${offerGroup.offerGroupId }&offerType=2" class="inb btn120x20" title="返回${offerGroup.offerGroupName }的营销案档次">返回营销案档次</a></div>
