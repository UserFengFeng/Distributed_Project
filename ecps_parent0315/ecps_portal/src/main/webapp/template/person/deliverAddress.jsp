...
<div class="w loc">
	...
	<p class="r"><a href="index.jsp" title="首页">首页</a><samp>&gt;</samp><a href="index.jsp" title="用户中心">用户中心</a><samp>&gt;</samp><span class="gray">收货地址</span></p>
...
<div class="w mt ofc">
	<div class="l wl">
		...
		<div class="box bg_gray">
			...
			<li><a href="deliverAddress.jsp" title="收货地址" class="here">收货地址</a></li>
