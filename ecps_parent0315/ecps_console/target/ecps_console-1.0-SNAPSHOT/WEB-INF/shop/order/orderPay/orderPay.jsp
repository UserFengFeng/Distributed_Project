...
<%--         <a id="label4" href="${path}/order/orderPay.do?orderState=17"  title="超时作废" class="nor">超时作废</a> --%>
   ...
   <table cellspacing="0" summary="" class="tab" id="myTable">
    ...
    <tr>
    <td><a href="${path }/WEB-INF/shop/order/orderPay/detail.jsp?orderId=3123"></a></td>
    <td></td>
    <td>
    ...
    <td><a href="${path }/WEB-INF/shop/order/orderPay/detail.jsp?orderId=3123">查看</a></td>
    </tr>
    ...
    <td><a href="${path }/WEB-INF/shop/order/orderPay/detail.jsp?orderId=3106">查看</a></td>
    </tr>
    ...
    <td><a href="${path }/WEB-INF/shop/order/orderPay/detail.jsp?orderId=3105">查看</a></td>
    </tr>
    ...
    <td><a href="${path }/WEB-INF/shop/order/orderPay/detail.jsp?orderId=3104">查看</a></td>
    </tr>
    ...
    <td><a href="${path }/WEB-INF/shop/order/orderPay/detail.jsp?orderId=3101">查看</a></td>
    </tr>
