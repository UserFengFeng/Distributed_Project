...
<div class="w loc">
	...
	<p class="r"><a href="index.jsp" title="首页">首页</a><samp>&gt;</samp><a href="index.jsp" title="用户中心">用户中心</a><samp>&gt;</samp><span class="gray">我的收藏</span></p>
...
<div class="w mt ofc">
	<div class="l wl">
		...
		<div class="box bg_gray">
			...
			<li><a href="myFavorites.jsp" title="我的收藏" class="here">我的收藏</a></li>
			</ul>
		</div>
